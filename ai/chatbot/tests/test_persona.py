...
def test_chat_message_camel_contract():
...
def test_build_system_prompt_reflects_attributes():
    spec = PersonaSpec(
        age_group="20대",
        gender="female",
        hobbies=["전시", "카페"],
...
def test_build_system_prompt_after_stage_and_gender():
...
def test_hobbies_default_empty():
